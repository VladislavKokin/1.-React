...
//     const docs1 = document.createElement('p')
//     docs1.className = 'read-the-docs'
//     docs1.textContent = 'Click on the Vite and React logos to learn more'

//     const docs2 = document.createElement('p')
//     docs2.className = 'read-the-docs'
//     docs2.textContent = new Date().toLocaleDateString('ru-RU')
